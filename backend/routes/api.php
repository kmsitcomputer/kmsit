...
Route::prefix('v1/courses')->group(function () {
    ...
    Route::post('/{slug}/enroll', [CourseController::class, 'enroll'])->middleware(['auth:sanctum', 'throttle:30,1']);
    Route::post('/{slug}/lessons/{lessonId}/complete', [CourseController::class, 'completeLesson'])->middleware(['auth:sanctum', 'throttle:60,1']);
    Route::get('/{slug}/progress', [CourseController::class, 'progress'])->middleware('auth:sanctum');
});
...
Route::get('/v1/certificates/verify/{number}', [CertificateController::class, 'verify']);
