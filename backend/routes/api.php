...
Route::prefix('v1')->middleware([EncryptCookies::class, StartSession::class, AuthenticateApiUser::class, \App\Http\Middleware\VerifyCsrfTokenForSession::class, \App\Http\Middleware\PreventMaintenanceAccess::class, \App\Http\Middleware\ValidateAuthEpoch::class])->group(function () {
    ...
    Route::get('/courses/{courseId}/live-classes', [LiveClassController::class, 'forCourse']);
    Route::post('/live-classes/{id}/join', [LiveClassController::class, 'join']);
    Route::get('/admin/courses/{courseId}/live-classes', [LiveClassController::class, 'index']);
    Route::post('/admin/courses/{courseId}/live-classes', [LiveClassController::class, 'store'])->middleware('throttle:30,1');
    ...
    Route::get('/shipping/provinces', [ShippingController::class, 'provinces'])->middleware('throttle:60,1');
    Route::get('/shipping/cities/{provinceId}', [ShippingController::class, 'cities'])->middleware('throttle:60,1');
